...
import {
    ...
    WalletAttr,
    WalletCreationAttr,
    RevenueAndExpenseAttr,
    RevenueAndExpenseCreationAttr,
    ListWalletsAttr,
    ListWalletsCreationAttr,
    ListWalletsWalletCreationAttr,
    ListWalletsWalletAttr,
...
const ListWallets: ModelDefined<ListWalletsAttr, ListWalletsCreationAttr> = 
    sequelize.define('ListWallets', {
        id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
    },
);

const ListWalletsWallet: ModelDefined<ListWalletsWalletAttr, ListWalletsWalletCreationAttr> =
    sequelize.define('ListWalletsWallet', {
        id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
    });

const Wallet: ModelDefined<WalletAttr, WalletCreationAttr> = 
...
const Expense: ModelDefined<RevenueAndExpenseAttr, RevenueAndExpenseCreationAttr> =
